...
from addresses.forms import AddressSearchForm, AddressCreationForm
...
class AddressCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("addresses:addresses")
...
class AddressConnectView(LoginRequiredMixin, generic.View):
    def get(self, request, pk: int) -> HttpResponse:
        ...
        return redirect(reverse("addresses:addresses"))
